...
struct LatticeView: View {
    ...
    var tutorialText: String  {
        ...
        switch tutorialStep {
        case 0: return "Welcome to the Lattice. This geometric grid is the mathematical foundation of Apple's PQ3 encryption, used to protect your messages on iPhone and iPad."
        case 1: return "To lock the shield, we need symmetry. You are connected to your Shadow—two parts of the same cryptographic key."
        case 2: return "Watch out: The connection is inverted! If you move Left, the Shadow moves Right. We must coordinate to survive."
        case 3: return "Guide both avatars to the Portals simultaneously. Once aligned (Pink with Pink and Blue with Blue), the Kyber Key is forged and the defense is activated!"
        default: return ""
        }
    }
}
...
struct PortalView: View {
    ...
    var body: some View {
        ZStack {
            ...
            Circle().stroke(color.opacity(0.5), lineWidth: 1).frame(width: size * 0.7, height: size * 0.7)
